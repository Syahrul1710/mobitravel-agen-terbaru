...
<head>
    ...
    <title>Tambah Rute Paket - MobiTravel Agen</title>
    <style>
...
<div class="main-content">
    <div class="card">
        <div class="card-header">
            <h2>Tambah Rute Paket</h2>
        </div>
        
        <form action="{{ route('agen.route-packages.store') }}" method="POST">
            @csrf
            
            <div class="row">
                <div class="form-group">
                    <label>Kota Asal *</label>
                    <input type="text" name="pickup_city" class="form-control" value="{{ old('pickup_city') }}" required placeholder="Contoh: Jakarta">
                    @error('pickup_city') <div class="error">{{ $message }}</div> @enderror
                </div>
                <div class="form-group">
                    <label>Kota Tujuan *</label>
                    <input type="text" name="dropoff_city" class="form-control" value="{{ old('dropoff_city') }}" required placeholder="Contoh: Surabaya">
            ...
            <div class="row">
                <div class="form-group">
                    ...
                    <input type="number" name="price_with_driver" class="form-control" value="{{ old('price_with_driver') }}" required placeholder="Contoh: 1500000">
                    @error('price_with_driver') <div class="error">{{ $message }}</div> @enderror
                </div>
                <div class="form-group">
                    <label>Harga Sewa Tanpa Sopir *</label>
                    <input type="number" name="price_without_driver" class="form-control" value="{{ old('price_without_driver') }}" required placeholder="Contoh: 1200000">
            ...
            <div class="row">
                <div class="form-group">
                    ...
                    <input type="number" name="estimated_hours" class="form-control" value="{{ old('estimated_hours') }}" placeholder="Contoh: 12">
                </div>
                <div class="form-group">
                    <label>Jarak (km)</label>
                    <input type="number" name="distance_km" class="form-control" value="{{ old('distance_km') }}" placeholder="Contoh: 800">
                </div>
            </div>
